    ...
    async create(createVehicleDto) {
        try {
            ...
            if (existingVehiclePlate) {
                throw new common_1.BadRequestException('Placa já cadastrada');
            }
            if (existingVehicleRenavam) {
                throw new common_1.BadRequestException('Renavam já cadastrado');
            }
...
__decorate([
    ...
    __metadata("design:returntype", vehicle_entity_1.Vehicle)
